# tabulation.R
#'
#' @title Rearrange a phytosociologic matrix, showing each differential taxa on top.
#'
#' @description This function reorders a phytosociological table rows based on, firstly, the number of groups in which a taxon occurs in, and secondly, on the within-group (adjusted) relative frequency. The columns are reordered using the given k-partition `p`.
#'
