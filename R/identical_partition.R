# identical_partition.R
#'
#' @title Do the vectors represent the same k-partition?
#'
#' @description Checks if two vectors represent the same k-partition.
#'
...
#' of a phytosociological table, indicating the group membership of each relevé
#' to one of k groups (i.e. a k-partition).
...
#'
#' @return `TRUE` if `p1`and `p2` represent the same k-partitions; `FALSE` otherwise.
#'
